...
happyExpList = Happy_Data_Array.listArray (0,51) ([49152,25,448,49152,1,0,0,0,0,0,0,2,0,64,448,0,0,4,49152,25,10208,4096,0,0,49152,1,8,0,0,0,0,0,0,0,0,0,49152,1,0,57344,39,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parserTurtle","TTLGraph","TTLSubject","TTLPredicate","PredicateObject","TTLObject","Url","'.'","':'","','","';'","string","url","unbasedUrl","unprefixedUrl","true","false","prefix","base","number","var","%eof"]
...
action_11 (11) = happyShift action_24
...
action_16 (6) = happyGoto action_13
action_16 (7) = happyGoto action_27
action_16 (9) = happyGoto action_15
...
happyReduction_2 (HappyAbsSyn9  happy_var_2)
	_
	 =  HappyAbsSyn4
		 (Base happy_var_2
	)
...
happyReduction_11 (HappyTerminal (TokenNumber _ happy_var_1))
	 =  HappyAbsSyn8
		 (IntObj happy_var_1
	)
...
happyReduction_16 (HappyTerminal (TokenUrl _ happy_var_1))
	 =  HappyAbsSyn9
...
happyReduction_17 (HappyTerminal (TokenUnbasedUrl _ happy_var_1))
	 =  HappyAbsSyn9
...
happyReduction_18 (HappyTerminal (TokenUnprefixedUrl _ happy_var_1))
	 =  HappyAbsSyn9
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenDot _ -> cont 10;
	TokenColon _ -> cont 11;
	TokenComa _ -> cont 12;
	TokenSemiColon _ -> cont 13;
	TokenString _ happy_dollar_dollar -> cont 14;
	TokenUrl _ happy_dollar_dollar -> cont 15;
	TokenUnbasedUrl _ happy_dollar_dollar -> cont 16;
	TokenUnprefixedUrl _ happy_dollar_dollar -> cont 17;
	TokenTrue _ -> cont 18;
	TokenFalse _ -> cont 19;
	TokenPrefix _ -> cont 20;
	TokenBase _ -> cont 21;
	TokenNumber _ happy_dollar_dollar -> cont 22;
