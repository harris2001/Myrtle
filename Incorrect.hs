...
evalBoolObj (AndVV a b) env = \o -> ((unwrap(lookupBoolEnv env a)) && (unwrap(lookupBoolEnv env b)))
...
evalBoolObj (OrVV a b) env = \o -> ((unwrap(lookupBoolEnv env a)) || (unwrap(lookupBoolEnv env b)))
...
evalBoolObj (GTVV a b) env = \o -> ((unwrap(lookupIntEnv env a)) > (unwrap(lookupIntEnv env b)))
...
evalBoolObj (LTVV a b) env = \o -> ((unwrap(lookupIntEnv env a)) < (unwrap(lookupIntEnv env b)))
